...
{
    syntaxFiles.insert("SQL",  ":/highlights/sql");
    syntaxFiles.insert("XML",  ":/highlights/xml");
    syntaxFiles.insert("JSON", ":/highlights/json");
    syntaxFiles.insert("CSON", ":/highlights/cson");
    syntaxFiles.insert("C/C++", ":/highlights/cpp");
