...
void QtPluginManagerDialogPrivate::initUi()
{
    ...
    QObject::connect(pluginView, &QtPluginTreeView::itemClicked,
                     q, &QtPluginManagerDialog::showProperties);
    QObject::connect(pluginView, &QtPluginTreeView::currentItemChanged,
                     q, &QtPluginManagerDialog::showProperties);
