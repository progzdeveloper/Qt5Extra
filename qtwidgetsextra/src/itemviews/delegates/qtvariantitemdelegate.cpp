...
QtVariantItemEditorFactory::QtVariantItemEditorFactory()
    : d(new QtVariantItemEditorFactoryPrivate)
{
}

QtVariantItemEditorFactory::~QtVariantItemEditorFactory() = default;
...
QtVariantItemDelegate::QtVariantItemDelegate(QObject *parent /*= 0*/)
    ...
    , d(new QtVariantItemDelegatePrivate)
{
    d->itemRole = Qt::EditRole;
    setItemEditorFactory(new QtVariantItemEditorFactory);
}

QtVariantItemDelegate::~QtVariantItemDelegate() = default;
