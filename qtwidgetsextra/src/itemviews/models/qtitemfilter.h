...
private:
    QScopedPointer<class QtItemFilterPrivate> d;
};
...
private:
    QScopedPointer<class QtItemFormatterPrivate> d;
};
...
private:
    QScopedPointer<class QtRichTextFormatterPrivate> d;
};
...
private:
    QScopedPointer<class QtItemHighlighterPrivate> d;
};
