...
QtLineBoxEdit::QtLineBoxEdit(QWidget *parent, Qt::WindowFlags flags) : QWidget(parent, flags)
{
    ...
    connect(edit, &QLineEdit::textChanged, this, &QtLineBoxEdit::textChanged);
    connect(edit, &QLineEdit::editingFinished, this, &QtLineBoxEdit::editingFinished);
    connect(button, &QToolButton::clicked, this, &QtLineBoxEdit::clicked);
                                         ...
                                         const QModelIndex &/* index */) const
{
    ...
    editor->setFocus();
    connect(editor, &QtLineBoxEdit::clicked, this, &QtLineBoxDelegate::buttonClicked);
    return editor;
}
