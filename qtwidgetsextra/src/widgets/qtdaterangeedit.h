...
private:
    friend class QtDateSpanEditPrivate;
    QScopedPointer<class QtDateSpanEditPrivate> d;
};
...
private:
    friend class QtDateRangeEditPrivate;
    QScopedPointer<class QtDateRangeEditPrivate> d;
};
