...
QtSlideController::QtSlideController(QObject* parent)
    : QObject(parent)
    , d(new QtSlideControllerPrivate(this))
{
...
QtSlideController::~QtSlideController() = default;
...
void QtSlideController::setWidget(QStackedWidget *w)
{
    ...
    if (w)
    {
        connect(w, &QStackedWidget::currentChanged, this, &QtSlideController::onCurrentChange);
        d->widget = w;
        d->widget->installEventFilter(this);
    }
}
