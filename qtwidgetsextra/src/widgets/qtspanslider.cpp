...
QtSpanSlider::QtSpanSlider(QWidget *parent)
    : QtSpanSlider(Qt::Horizontal, parent)
{
}
...
QtSpanSlider::QtSpanSlider(Qt::Orientation orientation, QWidget *parent)
    ...
    , d(new QtSpanSliderPrivate(this))
{
    connect(this, &QtSpanSlider::rangeChanged, this, &QtSpanSlider::updateRange);
    connect(this, &QtSpanSlider::sliderReleased, this, &QtSpanSlider::movePressedHandle);
}
 ...
 */
QtSpanSlider::~QtSpanSlider() = default;
