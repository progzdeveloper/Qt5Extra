    ...
    , d(new QtSlideButtonPrivate(this))
{
    ...
    connect(this, &QAbstractButton::clicked, d.data(), &QtSlideButtonPrivate::animate);
    // tigger update on animation finished
    connect(d->animation, &QPropertyAnimation::finished, this, qOverload<>(&QWidget::update));
    setCheckable(true);
}

QtSlideButton::~QtSlideButton() = default;
