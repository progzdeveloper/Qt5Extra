...
public:
    ...
    static inline int scrollBarOffset(const QScrollBar* sb)
    {
...
{
    return QPoint( scrollBarOffset( q_ptr->horizontalScrollBar() ),
                   scrollBarOffset( q_ptr->verticalScrollBar() ) );
}
...
QtMessageLogWidget::QtMessageLogWidget( QWidget * parent )
    ...
    , d( new QtMessageLogWidgetPrivate( this ) )
{
}

QtMessageLogWidget::~QtMessageLogWidget() = default;
