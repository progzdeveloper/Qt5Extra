...
QtStateIndicator::QtStateIndicator(QWidget *parent)
    ...
    , d(new QtStateIndicatorPrivate(this))
{
    setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);

    // TODO: fix me - implement me!
    //connect(this, &QAbstractButton::toggled, this, &QtStateIndicator::onToggle);
}

QtStateIndicator::QtStateIndicator(const QColor &color, Shape shape, QWidget *parent) :
    QAbstractButton(parent), d(new QtStateIndicatorPrivate(this))
{
    setColor(color);
    setShape(shape);
    setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
...
QtStateIndicator::~QtStateIndicator() = default;
