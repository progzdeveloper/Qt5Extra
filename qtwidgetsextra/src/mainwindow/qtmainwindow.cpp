...
QtMainWindow::QtMainWindow(QWidget *parent, Qt::WindowFlags f)
    ...
    , d(new QtMainWindowPrivate(this))
{
    d->createDockBars();
    connect(qApp, &QApplication::focusChanged, this, &QtMainWindow::focusChanged);
}
...
{
    connect(dockwidget, &QtDockWidget::dockLocationChanged, this, &QtMainWindow::changeDockLocation);
    connect(dockwidget, &QtDockWidget::autoHideChanged, this, &QtMainWindow::changeDockState);
...
void QtMainWindow::changeDockLocation(Qt::DockWidgetArea area)
{
    ...
    QtSideBars::const_iterator it = d->dockBars.cbegin();
    for (; it != d->dockBars.cend(); ++it)
    {
...
void QtMainWindow::focusChanged(QWidget * old, QWidget * now )
{
    ...
    QtDockWidgetList::const_iterator it = widgets.cbegin();
